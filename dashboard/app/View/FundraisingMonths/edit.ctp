<div class="row-fluid">
	<div class="span9">
		<?php echo $this->BootstrapForm->create('FundraisingMonth', array('class' => 'form-horizontal'));?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Fundraising Month')); ?></legend>
				<?php
				echo $this->BootstrapForm->input('fundraising_year_id');
				echo $this->BootstrapForm->input('month');
	...
	<div class="span3">
		...
		<ul class="nav nav-list">
			...
			<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FundraisingMonth.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FundraisingMonth.id'))); ?></li>
